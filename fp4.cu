...
)
{
    ...
    block_A.copy_in_host_to_host(A);
    block_B.copy_in_host_to_host(B);
    block_C.copy_in_host_to_host(C);
    block_SFA.copy_in_host_to_host(SFA);
    block_SFB.copy_in_host_to_host(SFB);
